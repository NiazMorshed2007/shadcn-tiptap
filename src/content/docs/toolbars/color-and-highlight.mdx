---
title: Color and Highlight Toolbar
description: A toolbar for adding color and highlight.
---

<Callout>
**Note:** This toolbar requires the [Color and Highlight](/docs/extensions/color-and-highlight) extension to be installed manually.
</Callout>

<ComponentPreview name="color-and-highlight-toolbar-example" />
...
```bash
npx shadcn add https://tiptap.niazmorshed.dev/r/color-and-highlight-toolbar.json
```
</TabsContent>
<TabsContent value="manual">
<Steps>
<Step>Install [Button](https://ui.shadcn.com/docs/components/button), [Tooltip](https://ui.shadcn.com/docs/components/tooltip), [Popover](https://ui.shadcn.com/docs/components/popover), [ScrollArea](https://ui.shadcn.com/docs/components/scroll-area), [Separator](https://ui.shadcn.com/docs/components/separator) components from @shadcn/ui</Step>
<Step>Copy & paste the following code under `components/toolbars/color-and-highlight.tsx`.</Step>
```jsx
"use client";
